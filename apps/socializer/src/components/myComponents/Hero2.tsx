  ...
  const features = [
    {
      ...
      description:
        "Automatically optimize content for TikTok, Instagram, YouTube, and more from a single creation workflow.",
    ...
    },
    {
      ...
      description:
        "Our AI analyzes trends and automatically enhances your content for maximum engagement across all platforms.",
    ...
    },
    {
      ...
      description:
        "Join 100+ creators already boosting their views and engagement with our proven tools and strategies.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              optimize, and scale your content across every major social media
              platform.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Icon */}
                    <div
                      className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${feature.gradient} 
                    ...
                    {/* Content */}
                    <h3
                      className="text-2xl font-bold mb-4 text-white group-hover:text-purple-100 
                    ...
                    <p
                      className="text-gray-300 mb-6 leading-relaxed group-hover:text-gray-200 
                              transition-colors duration-300"
                    >
                      {feature.description}
                    </p>
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-purple-400 rounded-full opacity-0 group-hover:opacity-60 transition-opacity duration-300 animate-float" />
                      <div
                        className="absolute top-3/4 right-1/4 w-1 h-1 bg-pink-400 rounded-full opacity-0 group-hover:opacity-60 transition-opacity duration-300 animate-float"
                        style={{ animationDelay: "0.5s" }}
                      />
                      <div
                        className="absolute top-1/2 right-1/3 w-1.5 h-1.5 bg-indigo-400 rounded-full opacity-0 group-hover:opacity-60 transition-opacity duration-300 animate-float"
          ...
          <div className="glass-strong rounded-3xl p-8 md:p-12 border border-white/10 animate-fade-in relative overflow-hidden">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300">
                Join thousands of creators who are already growing their
                audience with our AI tools
              </p>
            </div>
                ...
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    ...
                    className="w-12 h-12 rounded-full border-2 border-white/20 overflow-hidden 
                            bg-gradient-to-br from-purple-400 to-pink-400 hover-lift"
                  >
                    <Image
