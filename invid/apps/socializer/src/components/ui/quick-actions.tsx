...
import { Plus, Zap, History, Bookmark } from "lucide-react";
...
export const QuickActions = () => {
  ...
  const actions = [
    { icon: Zap, label: "Quick Title", href: "/dashboard/getTitle", color: "bg-yellow-500" },
    { icon: Plus, label: "New Project", href: "/dashboard", color: "bg-green-500" },
