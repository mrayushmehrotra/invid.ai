        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating Elements */}
              <div
                className="absolute -top-8 -right-8 glass rounded-2xl p-4 border border-white/10 
                            animate-pulse"
              >
                <div className="flex items-center gap-2">
              ...
              <div
                className="absolute -bottom-8 -left-8 glass rounded-2xl p-4 border border-white/10 
                            animate-pulse"
