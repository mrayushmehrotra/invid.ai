    ...
    <div className="min-h-screen w-full relative flex flex-col items-center justify-center antialiased px-4 pt-24 pb-8">
      <div className="max-w-4xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
          Transform your content strategy with AI-powered insights that maximize visibility, 
          engagement, and growth across all platforms.
        </p>
        
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <Link className="z-[99] group" href="/sign-up">
