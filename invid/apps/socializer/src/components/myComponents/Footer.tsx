...
import { Youtube, Facebook, Instagram, Twitter, Linkedin, Mail, Phone, MapPin } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <footer className="w-full glass border-t border-white/10 text-gray-300 py-16 px-6" id="footer">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              Empowering content creators with AI-powered tools to generate viral titles, 
              engaging descriptions, and trending hashtags that maximize reach and engagement.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                { name: "Description Generator", href: "/dashboard/getDescription" },
        ...
        <div className="glass rounded-2xl p-8 mb-12 border border-white/10">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300">Get the latest AI content creation tips and platform updates</p>
          </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-sm text-gray-400">
              © {currentYear} invid.ai. All rights reserved. Made with ❤️ for content creators.
            </div>
