...
const UnderConstructionCard = ({ CardTitle, about, origin, icon }: Props) => {
  ...
  return (
    <div className="w-full animate-fade-in">
      <div className="relative overflow-hidden rounded-2xl glass border border-orange-500/30 
        ...
        <div className="relative p-6 h-full flex flex-col">
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-orange-500/25 to-yellow-500/25 
                            border border-orange-400/20">
              <Icon className="w-6 h-6 text-orange-300" />
            </div>
            <div className="px-3 py-1 rounded-full bg-orange-500/15 border border-orange-500/30 
          ...
          {/* Placeholder Button */}
          <div className="w-full h-11 rounded-xl bg-orange-500/10 border border-orange-500/30
