...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="pt-24 pb-12 px-4">
        <div className="max-w-8xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-8">
            Choose your content type and let our AI generate optimized titles, descriptions, 
            and hashtags that maximize your reach.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            <div className="flex items-center gap-2 px-4 py-2 glass rounded-full">
              ...
              <span className="text-sm text-gray-300">95% Engagement Boost</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 glass rounded-full">
              <Sparkles className="w-4 h-4 text-purple-400" />
              <span className="text-sm text-gray-300">AI-Powered Optimization</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 justify-items-center" data-tour="dashboard-cards">
              {loading
                ? Data.map((_, index) => (
                ...
                : Data.map((item, key) => (
                    <SmartTooltip key={key} content={item.underConstruction ? "Coming soon!" : `Click to start generating ${item.title.origin.toLowerCase()}`}>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="glass rounded-2xl p-4 border border-white/10">
              <h3 className="text-lg font-bold gradient-text mb-3">💡 Pro Tips</h3>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0" />
                  <span className="text-gray-300">Use specific keywords for better SEO results</span>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-pink-400 rounded-full mt-2 flex-shrink-0" />
                  <span className="text-gray-300">Test multiple title variations</span>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full mt-2 flex-shrink-0" />
                  <span className="text-gray-300">Mix trending and niche hashtags</span>
                </div>
              </div>
            </div>
            ...
            {/* Recent Activity */}
            <div className="glass rounded-2xl p-4 border border-white/10">
              <h3 className="text-lg font-bold gradient-text mb-3">🔥 Trending</h3>
      ...
      {/* Quick Actions FAB - only show on dashboard */}
