...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log("Murf API Response Status:", response.status, response.statusText);
        ...
        console.log("Murf API Unknown Response (first 200 chars):", responseText.substring(0, 200));
